...
function register_mysettings(){
  ...
  register_setting( 'email-sms-settings-group', 'isms_ip_address' );
  ////
      ...
      <tr>
        <td valign="top" style="width:450px">
          <fieldset class="bmostyle_admin">
           <legend>iSMS</legend>
                 <div><label>&nbsp;</label>Register <a href="http://www.isms.com.my/" target="_blank">isms.com.my</a> and get 10 credits for free!</div>
